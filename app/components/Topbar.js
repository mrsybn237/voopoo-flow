...
export default function Topbar({ onOpenPalette, me }) {
  ...
  return (
    <div className="sticky top-0 z-30 bg-void/85 backdrop-blur-xl border-b border-line-soft mb-10">
      <div className="px-6 lg:px-10 xl:px-16 py-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <img src="/logo-full.png" alt="VOOPOO Indonesia" className="h-6 w-auto object-contain" />
          <div className="hidden sm:block w-px h-6 bg-line-soft" />
          <div className="hidden sm:block text-muted text-[13.5px] leading-tight">
